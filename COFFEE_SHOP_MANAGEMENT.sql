...
--INSERT INTO NHANVIEN(MANV, HOTEN, GIOITINH, DIACHI, CMND, SDT, NGAYVL, LUONG, CHUCVU) values('NV00001', 'VDT', 'Nam', '123 duong abc', '245386118', '0931646220', '11-12-2001', 10000, N'Phục vụ')

--INSERT INTO ACCOUNT(MANV, USERNAME, PASS, TINHTRANG) VALUES ('NV00001','2', '2', N'Đang làm việc')

--UPDATE NHANVIEN SET HOTEN = 'Nguyen Van A', GIOITINH = N'Nữ', DIACHI = 'aaaa', CMND = '12345679876543', SDT = '00000', NGAYVL = '20-12-1019', LUONG = 1, CHUCVU = 'quét rác' WHERE MANV = 'NV0004'
